...
import { ArrowRight, Zap, TrendingUp, Users, BarChart3, MessageSquare, Globe, Smartphone } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Trust Strip */}
      <section className="py-12 border-y border-white/20 bg-white/20 backdrop-blur-sm">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
            {services.map((service, idx) => {
              ...
              const cardRotation = shouldAnimate
                ? useTransform(servicesScrollProgress, [0, 1], [-2 + idx * 0.5, 2 - idx * 0.5])
                : 0;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            {pricingPlans.map((plan, idx) => (
              ...
              >
                ...
                <div className={`glass-card p-8 h-full ${plan.popular ? 'ring-2 ring-cyan-400/50' : ''}`}>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-16">
            {industries.map((industry, idx) => (
              <ScrollReveal key={idx} delay={idx} direction="up">
                <motion.div
                  className="glass-card p-6 text-center hover:bg-white/60 transition-colors cursor-pointer"
